...
def update_line(num, r,line,ax):
    ...
    lc = Line3DCollection(segments[0:(num)], cmap=plt.get_cmap('coolwarm'),
                    norm=norm)
...
ax.set_ylabel("Y")
ax.set_zlabel("Z")
ax.set_title("Torsion Color Plot")
...
#line2 = ax.plot([x[0:1],x[0:1]+B[0,0:1]],[y[0:1],y[0:1]+ B[1,0:1]],[z[0:1], z[0:1]+B[2,0:1]],'r',label="B")[0]
#line3 = ax.plot([x[0:1],x[0:1]+N[0,0:1]],[y[0:1],y[0:1]+ N[1,0:1]],[z[0:1], z[0:1]+N[2,0:1]],'b',label="N")[0]
#line4 = ax.plot([x[0:1],x[0:1]+T[0,0:1]],[y[0:1],y[0:1]+ T[1,0:1]],[z[0:1], z[0:1]+T[2,0:1]],'g',label="T")[0]
lines = [line1,line2,line3,line4]
#ax.plot(x, y, z)
#ax.plot([x[num],x[num]+B[0,num]],[y[num],y[num]+ B[1,num]],[z[num], z[num]+B[2,num]])
